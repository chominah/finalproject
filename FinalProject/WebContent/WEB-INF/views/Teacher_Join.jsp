...
<body>
	<div id="content">
		<form method="post" action="teacherjoin" id="join">
			<fieldset>
				<legend>강사 회원가입 폼</legend>
				<table>
					<td style="width: 200px;">아이디 : &nbsp;</td>
					<td>
                     <input type="text" class="form-control" placeholder="아이디" name="tid" id="tid" required="required" style="width: 700px;">
					</td>
					<td>&nbsp; 
				...
				<table>
					...
					<input type="password" class="form-control"
						placeholder="비밀번호" name="tpwd" id="tpwd" required="required"
						pattern="[a-zA-Z]+[0-9]+"
				...
				<table>
					...
					<td><input type="text" id="tpost" name="tpost"
				...
				<table>
					...
					<td><input type="text" id="taddr1" name="taddr1"
				...
				<table>
					...
					<td><input type="text" id="taddr2" name="taddr2"
				...
				<table>
					...
					<td><input type="text" name="tphone" id="tphone"
				...
				<table>
					...
					<td><input type="text" name="tmail" id="tmail"
		...
		$(function() {
					...
					function() {
						$.ajax({
							...
							success : function(data) {
								console.log(data);
								if (data == 1) {
									$('#chk_tid').show().css("color", "red")
											.text("사용불가능한 아이디입니다.");
								} else {
									$('#chk_tid').show().css("color", "blue")
											.text("사용가능한 아이디입니다.");
								}
							}
						});
			...
			var interVal = setInterval(function() {
				if ($('#tpwd').val().length >= 6) {
					$('#chk_tpwd').show().css("color", "blue").text(
							"적합한 길이입니다.");
				} else {
					$('#chk_tpwd').show().css("color", "red").text(
							"6자리이상 입력해주세요.")
				}
			});
		});
